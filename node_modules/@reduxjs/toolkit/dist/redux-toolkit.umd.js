    ...
    return caseReducers.reduce(function (previousState, caseReducer) {
      if (caseReducer) {
        if (n(previousState)) {
          ...
          // these two types.
          return it(previousState, function (draft) {
